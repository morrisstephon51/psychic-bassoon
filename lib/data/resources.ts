...
export const resources: Resource[] = [
  {
    ...
    downloadUrl: '#',
    emailGated: true,
    thumbnail: 'https://via.placeholder.com/300x200/6B21A8/ffffff?text=AI+Starter+Kit',
  },
  {
    id: '2',
    title: 'Top 10 Free AI Tools Cheatsheet',
    description:
      "A quick-reference guide to the 10 best free AI tools — what they do, how to access them, and the best use cases for each. One page. Print-friendly. Share with your whole team.",
    format: 'Cheatsheet',
    pages: '1 page',
    downloadUrl: '#',
    emailGated: false,
    thumbnail: 'https://via.placeholder.com/300x200/22C55E/ffffff?text=AI+Tools+Cheatsheet',
  },
  {
    id: '3',
    ...
    downloadUrl: '#',
    emailGated: true,
    thumbnail: 'https://via.placeholder.com/300x200/F59E0B/ffffff?text=Resume+Prompts',
  },
  {
    id: '4',
    ...
    downloadUrl: '#',
    emailGated: true,
    thumbnail: 'https://via.placeholder.com/300x200/7C3AED/ffffff?text=Business+Playbook',
  },
  {
    id: '5',
    ...
    downloadUrl: '#',
    emailGated: true,
    thumbnail: 'https://via.placeholder.com/300x200/0EA5E9/ffffff?text=30+Day+Challenge',
  },
  {
    id: '6',
    ...
    downloadUrl: '#',
    emailGated: false,
    thumbnail: 'https://via.placeholder.com/300x200/EC4899/ffffff?text=Church+%26+Nonprofits',
  },
]
